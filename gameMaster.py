...
import testStates
import DSBGagent
# from DSBGagent import DSBGagent as agentW
# #import McGammon as agent2
# from DSBGagent import DSBGagent as agentR
...
def run(agent1, agent2, max_secs_per_move, initial_state=bgstate(), deterministic=False):
  ...
  while(not DONE):
    print("state:")
    print(agent1.states_created)
    print("cutoffs:")
    print(agent1.cutoffs)
    print("Current state:")
...
agent1=DSBGagent.DSBGagent()
agent2=DSBGagent.DSBGagent()
